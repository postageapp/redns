class ReDNS::Message < ReDNS::Fragment
  ...
  attribute :answer_authenticated, boolean: true, default: false
  ...
  def to_s
    ...
    flags << 'ad' if (answer_authenticated?)
  ...
  def serialize(buffer = ReDNS::Buffer.new)
    buffer.pack(
      ...
      (
        ...
        (self.answer_authenticated? ? 0x0020 : 0) |
